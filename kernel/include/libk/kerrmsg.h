#ifndef _KER_ERR_MSG_H_
#define _KER_ERR_MSG_H_

#include <libk/stdio.h>

#define FATAL_CLEENUP_LABEL                "FATAL ERROR! -  "
...
#define kermsg_print_fatal_error(MESSAGE)  (printf(FATAL_CLEENUP_LABEL MESSAGE))
